  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-card rounded-xl shadow-sm border p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm text-muted-foreground">Paying Companies</span>
          </div>
          <p className="text-3xl font-bold text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Revenue by Tier */}
        <div className="bg-card rounded-xl shadow-sm border p-6">
          <h2 className="text-lg font-semibold text-foreground mb-4">Revenue by Tier</h2>
              ...
              {revenue.revenueByTier.map((item: any) => {
                ...
                return (
                  <div key={item.tier}>
                    ...
                    <span className="text-xs text-muted-foreground">{percentage}% of base MRR</span>
                  </div>
                );
              })}
            </div>
