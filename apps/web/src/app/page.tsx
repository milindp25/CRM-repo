  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white overflow-hidden">
      ...
      <section id="features" className="relative py-24 lg:py-32">
        {/* Background accent */}
        <div className="absolute top-1/2 left-[-10%] w-[500px] h-[500px] rounded-full bg-blue-200/30 dark:bg-blue-600/5 blur-3xl pointer-events-none" aria-hidden="true" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-500 dark:text-slate-400">
              One platform to handle it all — from hiring to retirement.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  'Calculate salaries, taxes, and deductions automatically. Generate payslips in one click. Never miss a pay day again.',
              ...
              },
              {
                ...
                description:
                  'Know who\'s in, who\'s out, and who\'s running late — instantly. Manage shifts, overtime, and schedules without the headache.',
              ...
              },
              {
                ...
                description:
                  'Employees request leave, managers approve with one tap. Auto-track balances, holidays, and company policies effortlessly.',
              ...
              },
              {
                ...
                description:
                  'Run review cycles that employees actually look forward to. Set goals, give feedback, and track growth — all in one place.',
              ...
              },
              {
                ...
                description:
                  'Post jobs, track candidates, schedule interviews, and send offers. Fill roles faster without switching between tools.',
              ...
              },
              {
                ...
                description:
                  'See what\'s working and what\'s not at a glance. Headcount trends, cost breakdowns, and team health — all on your dashboard.',
              ...
              <div
                key={feature.title}
                className={`group relative rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.06] p-8 hover:bg-slate-50 dark:hover:bg-white/[0.06] hover:border-slate-300 dark:hover:border-white/10 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${feature.glow}`}
              >
                {/* Icon */}
                <div
